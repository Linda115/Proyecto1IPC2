<%-- 
    Document   : CambiarNombreUsuario
    Created on : 5 sep 2021, 23:48:49
    ...
    <body>
        <div class="container">
            <form method="POST" action="registrar">
                <label for="materiaPrima">Escribe el nombre del usuario, y el nuevo nombre que deseas ingresar al sistema: </label>
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="materiaPrima">Escribe el nombre de usuario de la lista de arriba a la cual deseas cambiarle el nombre: </label>
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="Nombre">Escribe el nuevo nombre del usuario:</label>
                    </div>
                    <div class="col-75">
